package olivsoftdesktop.utils.gui;
  ...
  extends JPanel
{
    ...
    throws Exception
  {
    ...
    bottomLeft.setText("Details avaiable at ");
    bottomRight.setText("<html><u>The Desktop History Page</u></html>");
    ...
    bottomRight.addMouseListener(new MouseAdapter()
      {
        ...
        {
          bottomRight.setForeground(PURPLE);
          bottomRight.repaint();
        }
