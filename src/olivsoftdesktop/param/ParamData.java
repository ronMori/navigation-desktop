...
public class ParamData 
{
  ...
  public final static String[] helptext =
  {
    ...
    /* 11 */ "Inserted leap seconds, check out http://aa.usno.navy.mil/data/docs/celnavtable.php and http://maia.usno.navy.mil/",
    ...
    /* 22 */ "Star Finder. Modification will require restart.",
    ...
    /* 26 */ "Almanac Publisher, by month, by year. Modification will require restart.",
